...
export type CreateLinkedFileTypeEnum =
  (typeof CreateLinkedFileTypeEnum)[keyof typeof CreateLinkedFileTypeEnum]
...
export function CreateLinkedFileFromJSONTyped(
  json: any,
