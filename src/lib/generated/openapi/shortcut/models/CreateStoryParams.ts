...
export type CreateStoryParamsStoryTypeEnum =
  (typeof CreateStoryParamsStoryTypeEnum)[keyof typeof CreateStoryParamsStoryTypeEnum]
...
export type CreateStoryParamsMoveToEnum =
  (typeof CreateStoryParamsMoveToEnum)[keyof typeof CreateStoryParamsMoveToEnum]
...
export function CreateStoryParamsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    storyLinks: !exists(json, 'story_links')
      ? undefined
      : (json['story_links'] as Array<any>).map(CreateStoryLinkParamsFromJSON),
    ...
    comments: !exists(json, 'comments')
      ? undefined
      : (json['comments'] as Array<any>).map(CreateStoryCommentParamsFromJSON),
    ...
    tasks: !exists(json, 'tasks')
      ? undefined
      : (json['tasks'] as Array<any>).map(CreateTaskParamsFromJSON),
...
export function CreateStoryParamsToJSON(value?: CreateStoryParams | null): any {
  ...
  return {
    ...
    story_links:
      value.storyLinks === undefined
        ? undefined
        : (value.storyLinks as Array<any>).map(CreateStoryLinkParamsToJSON),
    labels:
    ...
    completed_at_override:
      value.completedAtOverride === undefined ? undefined : value.completedAtOverride.toISOString(),
    name: value.name,
    comments:
      value.comments === undefined
        ? undefined
        : (value.comments as Array<any>).map(CreateStoryCommentParamsToJSON),
    ...
    tasks:
      value.tasks === undefined
        ? undefined
        : (value.tasks as Array<any>).map(CreateTaskParamsToJSON),
    started_at_override:
      value.startedAtOverride === undefined ? undefined : value.startedAtOverride.toISOString(),
