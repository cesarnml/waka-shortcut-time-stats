...
export type CustomFieldEntityTypeEnum =
  (typeof CustomFieldEntityTypeEnum)[keyof typeof CustomFieldEntityTypeEnum]
...
export type CustomFieldFieldTypeEnum =
  (typeof CustomFieldFieldTypeEnum)[keyof typeof CustomFieldFieldTypeEnum]
...
export function CustomFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomField {
  ...
  return {
    ...
    values: !exists(json, 'values')
      ? undefined
      : (json['values'] as Array<any>).map(CustomFieldEnumValueFromJSON),
  ...
  return {
    ...
    values:
      value.values === undefined
        ? undefined
        : (value.values as Array<any>).map(CustomFieldEnumValueToJSON),
