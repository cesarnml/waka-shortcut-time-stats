 ...
 */
export function instanceOfEpic(value: object): boolean {
  let isInstance = true
...
export function EpicFromJSONTyped(json: any, ignoreDiscriminator: boolean): Epic {
...
export function EpicToJSON(value?: Epic | null): any {
  if (value === undefined) {
    return undefined
  }
  if (value === null) {
