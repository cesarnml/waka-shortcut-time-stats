...
import type { ThreadedComment } from './ThreadedComment';
import {
    ThreadedCommentFromJSON,
    ThreadedCommentFromJSONTyped,
...
/**
 * Check if a given object implements the EpicSearchResult interface.
 */
export function instanceOfEpicSearchResult(value: object): boolean {
    let isInstance = true;
...
export function EpicSearchResultFromJSON(json: any): EpicSearchResult {
    return EpicSearchResultFromJSONTyped(json, false);
}

export function EpicSearchResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): EpicSearchResult {
    ...
    return {
        ...
        'comments': !exists(json, 'comments') ? undefined : ((json['comments'] as Array<any>).map(ThreadedCommentFromJSON)),
...
export function EpicSearchResultToJSON(value?: EpicSearchResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'comments': value.comments === undefined ? undefined : ((value.comments as Array<any>).map(ThreadedCommentToJSON)),
