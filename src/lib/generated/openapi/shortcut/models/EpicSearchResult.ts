...
export function EpicSearchResultFromJSONTyped(
  json: any,
  ...
  return {
    ...
    comments: !exists(json, 'comments')
      ? undefined
      : (json['comments'] as Array<any>).map(ThreadedCommentFromJSON),
  ...
  return {
    ...
    comments:
      value.comments === undefined
        ? undefined
        : (value.comments as Array<any>).map(ThreadedCommentToJSON),
