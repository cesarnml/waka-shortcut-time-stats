...
export type HistoryActionStoryLinkUpdateActionEnum = typeof HistoryActionStoryLinkUpdateActionEnum[keyof typeof HistoryActionStoryLinkUpdateActionEnum];
...
export type HistoryActionStoryLinkUpdateVerbEnum = typeof HistoryActionStoryLinkUpdateVerbEnum[keyof typeof HistoryActionStoryLinkUpdateVerbEnum];
...
export function HistoryActionStoryLinkUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): HistoryActionStoryLinkUpdate {
...
export function HistoryActionStoryLinkUpdateToJSON(value?: HistoryActionStoryLinkUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
