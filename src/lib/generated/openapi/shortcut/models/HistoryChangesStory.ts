...
export function HistoryChangesStoryFromJSONTyped(
  json: any,
  ...
  return {
    ...
    archived: !exists(json, 'archived')
      ? undefined
      : StoryHistoryChangeOldNewBoolFromJSON(json['archived']),
    started: !exists(json, 'started')
      ? undefined
      : StoryHistoryChangeOldNewBoolFromJSON(json['started']),
    taskIds: !exists(json, 'task_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesIntFromJSON(json['task_ids']),
    mentionIds: !exists(json, 'mention_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesUuidFromJSON(json['mention_ids']),
    storyType: !exists(json, 'story_type')
      ? undefined
      : StoryHistoryChangeOldNewStrFromJSON(json['story_type']),
    name: !exists(json, 'name') ? undefined : StoryHistoryChangeOldNewStrFromJSON(json['name']),
    completed: !exists(json, 'completed')
      ? undefined
      : StoryHistoryChangeOldNewBoolFromJSON(json['completed']),
    blocker: !exists(json, 'blocker')
      ? undefined
      : StoryHistoryChangeOldNewBoolFromJSON(json['blocker']),
    epicId: !exists(json, 'epic_id')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['epic_id']),
    branchIds: !exists(json, 'branch_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesIntFromJSON(json['branch_ids']),
    commitIds: !exists(json, 'commit_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesIntFromJSON(json['commit_ids']),
    requestedById: !exists(json, 'requested_by_id')
      ? undefined
      : StoryHistoryChangeOldNewUuidFromJSON(json['requested_by_id']),
    iterationId: !exists(json, 'iteration_id')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['iteration_id']),
    labelIds: !exists(json, 'label_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesIntFromJSON(json['label_ids']),
    groupId: !exists(json, 'group_id')
      ? undefined
      : StoryHistoryChangeOldNewUuidFromJSON(json['group_id']),
    workflowStateId: !exists(json, 'workflow_state_id')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['workflow_state_id']),
    objectStoryLinkIds: !exists(json, 'object_story_link_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesIntFromJSON(json['object_story_link_ids']),
    followerIds: !exists(json, 'follower_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesUuidFromJSON(json['follower_ids']),
    ownerIds: !exists(json, 'owner_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesUuidFromJSON(json['owner_ids']),
    customFieldValueIds: !exists(json, 'custom_field_value_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesUuidFromJSON(json['custom_field_value_ids']),
    estimate: !exists(json, 'estimate')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['estimate']),
    subjectStoryLinkIds: !exists(json, 'subject_story_link_ids')
      ? undefined
      : StoryHistoryChangeAddsRemovesIntFromJSON(json['subject_story_link_ids']),
    blocked: !exists(json, 'blocked')
      ? undefined
      : StoryHistoryChangeOldNewBoolFromJSON(json['blocked']),
    projectId: !exists(json, 'project_id')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['project_id']),
    deadline: !exists(json, 'deadline')
      ? undefined
      : StoryHistoryChangeOldNewStrFromJSON(json['deadline']),
  }
}
