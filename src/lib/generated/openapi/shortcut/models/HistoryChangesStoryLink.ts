...
export function HistoryChangesStoryLinkFromJSONTyped(
  json: any,
  ...
  return {
    ...
    objectId: !exists(json, 'object_id')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['object_id']),
    subjectId: !exists(json, 'subject_id')
      ? undefined
      : StoryHistoryChangeOldNewIntFromJSON(json['subject_id']),
  }
}
