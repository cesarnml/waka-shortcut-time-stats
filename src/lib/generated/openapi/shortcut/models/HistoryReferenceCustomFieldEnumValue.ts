...
export function HistoryReferenceCustomFieldEnumValueFromJSON(
  json: any,
): HistoryReferenceCustomFieldEnumValue {
  return HistoryReferenceCustomFieldEnumValueFromJSONTyped(json, false)
}

export function HistoryReferenceCustomFieldEnumValueFromJSONTyped(
  json: any,
...
export function HistoryReferenceCustomFieldEnumValueToJSON(
  value?: HistoryReferenceCustomFieldEnumValue | null,
): any {
  if (value === undefined) {
    return undefined
  }
