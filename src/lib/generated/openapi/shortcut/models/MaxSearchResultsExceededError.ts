...
export type MaxSearchResultsExceededErrorErrorEnum = typeof MaxSearchResultsExceededErrorErrorEnum[keyof typeof MaxSearchResultsExceededErrorErrorEnum];
...
export type MaxSearchResultsExceededErrorMaximumResultsEnum = typeof MaxSearchResultsExceededErrorMaximumResultsEnum[keyof typeof MaxSearchResultsExceededErrorMaximumResultsEnum];
...
export function MaxSearchResultsExceededErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): MaxSearchResultsExceededError {
...
export function MaxSearchResultsExceededErrorToJSON(value?: MaxSearchResultsExceededError | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
