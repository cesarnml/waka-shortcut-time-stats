...
export type SearchStoriesStoryTypeEnum = typeof SearchStoriesStoryTypeEnum[keyof typeof SearchStoriesStoryTypeEnum];
...
export type SearchStoriesWorkflowStateTypesEnum = typeof SearchStoriesWorkflowStateTypesEnum[keyof typeof SearchStoriesWorkflowStateTypesEnum];
...
export function SearchStoriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchStories {
    ...
    return {
        ...
        'completedAtEnd': !exists(json, 'completed_at_end') ? undefined : (new Date(json['completed_at_end'])),
        'workflowStateTypes': !exists(json, 'workflow_state_types') ? undefined : json['workflow_state_types'],
        'deadlineEnd': !exists(json, 'deadline_end') ? undefined : (new Date(json['deadline_end'])),
        'createdAtStart': !exists(json, 'created_at_start') ? undefined : (new Date(json['created_at_start'])),
        ...
        'completedAtStart': !exists(json, 'completed_at_start') ? undefined : (new Date(json['completed_at_start'])),
        'updatedAtStart': !exists(json, 'updated_at_start') ? undefined : (new Date(json['updated_at_start'])),
    };
}
...
export function SearchStoriesToJSON(value?: SearchStories | null): any {
    ...
    return {
        ...
        'project_ids': value.projectIds === undefined ? undefined : Array.from(value.projectIds as Set<any>),
        'updated_at_end': value.updatedAtEnd === undefined ? undefined : (value.updatedAtEnd.toISOString()),
        'completed_at_end': value.completedAtEnd === undefined ? undefined : (value.completedAtEnd.toISOString()),
        ...
        'created_at_start': value.createdAtStart === undefined ? undefined : (value.createdAtStart.toISOString()),
        ...
        'iteration_ids': value.iterationIds === undefined ? undefined : Array.from(value.iterationIds as Set<any>),
        'created_at_end': value.createdAtEnd === undefined ? undefined : (value.createdAtEnd.toISOString()),
        'deadline_start': value.deadlineStart === undefined ? undefined : (value.deadlineStart.toISOString()),
        ...
        'completed_at_start': value.completedAtStart === undefined ? undefined : (value.completedAtStart.toISOString()),
        'updated_at_start': value.updatedAtStart === undefined ? undefined : (value.updatedAtStart.toISOString()),
    };
}
