...
export function StoryContentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoryContents {
    ...
    return {
        ...
        'labels': !exists(json, 'labels') ? undefined : ((json['labels'] as Array<any>).map(LabelSlimFromJSON)),
        ...
        'tasks': !exists(json, 'tasks') ? undefined : ((json['tasks'] as Array<any>).map(StoryContentsTaskFromJSON)),
...
export function StoryContentsToJSON(value?: StoryContents | null): any {
    ...
    return {
        ...
        'labels': value.labels === undefined ? undefined : ((value.labels as Array<any>).map(LabelSlimToJSON)),
        ...
        'tasks': value.tasks === undefined ? undefined : ((value.tasks as Array<any>).map(StoryContentsTaskToJSON)),
