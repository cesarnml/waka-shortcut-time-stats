...
export function StorySearchResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): StorySearchResult {
    ...
    return {
        ...
        'linkedFiles': !exists(json, 'linked_files') ? undefined : ((json['linked_files'] as Array<any>).map(LinkedFileFromJSON)),
        'fileIds': !exists(json, 'file_ids') ? undefined : json['file_ids'],
        'numTasksCompleted': !exists(json, 'num_tasks_completed') ? undefined : json['num_tasks_completed'],
        ...
        'comments': !exists(json, 'comments') ? undefined : ((json['comments'] as Array<any>).map(StoryCommentFromJSON)),
        'blocker': json['blocker'],
        'branches': !exists(json, 'branches') ? undefined : ((json['branches'] as Array<any>).map(BranchFromJSON)),
        'epicId': json['epic_id'],
        ...
        'pullRequests': !exists(json, 'pull_requests') ? undefined : ((json['pull_requests'] as Array<any>).map(PullRequestFromJSON)),
        ...
        'commits': !exists(json, 'commits') ? undefined : ((json['commits'] as Array<any>).map(CommitFromJSON)),
        'files': !exists(json, 'files') ? undefined : ((json['files'] as Array<any>).map(UploadedFileFromJSON)),
...
export function StorySearchResultToJSON(value?: StorySearchResult | null): any {
    ...
    return {
        ...
        'linked_files': value.linkedFiles === undefined ? undefined : ((value.linkedFiles as Array<any>).map(LinkedFileToJSON)),
        ...
        'comments': value.comments === undefined ? undefined : ((value.comments as Array<any>).map(StoryCommentToJSON)),
        'blocker': value.blocker,
        'branches': value.branches === undefined ? undefined : ((value.branches as Array<any>).map(BranchToJSON)),
        ...
        'pull_requests': value.pullRequests === undefined ? undefined : ((value.pullRequests as Array<any>).map(PullRequestToJSON)),
        ...
        'commits': value.commits === undefined ? undefined : ((value.commits as Array<any>).map(CommitToJSON)),
        'files': value.files === undefined ? undefined : ((value.files as Array<any>).map(UploadedFileToJSON)),
