...
export function UpdateCustomFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateCustomField {
    ...
    return {
        ...
        'values': !exists(json, 'values') ? undefined : ((json['values'] as Array<any>).map(UpdateCustomFieldEnumValueFromJSON)),
...
export function UpdateCustomFieldToJSON(value?: UpdateCustomField | null): any {
    ...
    return {
        ...
        'name': value.name,
        'values': value.values === undefined ? undefined : ((value.values as Array<any>).map(UpdateCustomFieldEnumValueToJSON)),
