...
export type UpdateLinkedFileTypeEnum =
  (typeof UpdateLinkedFileTypeEnum)[keyof typeof UpdateLinkedFileTypeEnum]
...
export function UpdateLinkedFileFromJSONTyped(
  json: any,
