...
export type UpdateStoriesStoryTypeEnum =
  (typeof UpdateStoriesStoryTypeEnum)[keyof typeof UpdateStoriesStoryTypeEnum]
...
export type UpdateStoriesMoveToEnum =
  (typeof UpdateStoriesMoveToEnum)[keyof typeof UpdateStoriesMoveToEnum]
...
export function UpdateStoriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateStories {
  ...
  return {
    ...
    followerIdsRemove: !exists(json, 'follower_ids_remove')
      ? undefined
      : json['follower_ids_remove'],
    ...
    customFieldsRemove: !exists(json, 'custom_fields_remove')
      ? undefined
      : (json['custom_fields_remove'] as Array<any>).map(CustomFieldValueParamsFromJSON),
    labelsAdd: !exists(json, 'labels_add')
      ? undefined
      : (json['labels_add'] as Array<any>).map(CreateLabelParamsFromJSON),
    ...
    customFieldsAdd: !exists(json, 'custom_fields_add')
      ? undefined
      : (json['custom_fields_add'] as Array<any>).map(CustomFieldValueParamsFromJSON),
    projectId: !exists(json, 'project_id') ? undefined : json['project_id'],
    labelsRemove: !exists(json, 'labels_remove')
      ? undefined
      : (json['labels_remove'] as Array<any>).map(CreateLabelParamsFromJSON),
...
export function UpdateStoriesToJSON(value?: UpdateStories | null): any {
  ...
  return {
    ...
    follower_ids_add:
      value.followerIdsAdd === undefined ? undefined : Array.from(value.followerIdsAdd as Set<any>),
    epic_id: value.epicId,
    external_links: value.externalLinks,
    follower_ids_remove:
      value.followerIdsRemove === undefined
        ? undefined
        : Array.from(value.followerIdsRemove as Set<any>),
    requested_by_id: value.requestedById,
    iteration_id: value.iterationId,
    custom_fields_remove:
      value.customFieldsRemove === undefined
        ? undefined
        : (value.customFieldsRemove as Array<any>).map(CustomFieldValueParamsToJSON),
    labels_add:
      value.labelsAdd === undefined
        ? undefined
        : (value.labelsAdd as Array<any>).map(CreateLabelParamsToJSON),
    ...
    owner_ids_remove:
      value.ownerIdsRemove === undefined ? undefined : Array.from(value.ownerIdsRemove as Set<any>),
    custom_fields_add:
      value.customFieldsAdd === undefined
        ? undefined
        : (value.customFieldsAdd as Array<any>).map(CustomFieldValueParamsToJSON),
    project_id: value.projectId,
    labels_remove:
      value.labelsRemove === undefined
        ? undefined
        : (value.labelsRemove as Array<any>).map(CreateLabelParamsToJSON),
    deadline:
    ...
    owner_ids_add:
      value.ownerIdsAdd === undefined ? undefined : Array.from(value.ownerIdsAdd as Set<any>),
  }
}
