...
export function UpdateStoryContentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateStoryContents {
    ...
    return {
        ...
        'tasks': !exists(json, 'tasks') ? undefined : ((json['tasks'] as Array<any>).map(EntityTemplateTaskFromJSON)),
...
export function UpdateStoryContentsToJSON(value?: UpdateStoryContents | null): any {
    ...
    return {
        ...
        'tasks': value.tasks === undefined ? undefined : ((value.tasks as Array<any>).map(EntityTemplateTaskToJSON)),
